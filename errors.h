...
typedef enum{NO_FILES=1, FAILED_OPEN, ERRORS_IN_FILE, WRONG_FILES, MISSING_CMD, UNDEF_CMD, LABEL_NUMERIC_START, 
             LABEL_LENGTH, ILLEGAL_LABEL_CHARS, LABEL_EXIST, SAVED_WORD, DIR_NO_FOUND, DATA_INVALID, MISSING_STRING_START, 
             ...
             LABEL_ENTRY_EXTERN, MISSING_LBL, EXTRA_INPUT} errorList;
