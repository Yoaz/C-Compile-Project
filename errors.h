...
typedef enum{NO_FILES=1, FAILED_OPEN, ERRORS_IN_FILE, WRONG_FILES, MISSING_CMD, UNDEF_CMD, LABEL_NUMERIC_START, 
             ...
             LINE_LENGTH, LABEL_ENTRY_EXTERN, MISSING_LBL, MISSING_ARG, TOO_MANY_ARGS, TOO_FEW_ARGS,INVALID_INST_ARG, 
             INVALID_REG_REF_SYNT, IMMIDIET_SYNTAX, NUM_RANGE, EXTRA_INPUT} errorList;
